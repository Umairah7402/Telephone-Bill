...
public class TelephoneCompany_4 {
        ...
        choice = input.nextInt();
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.printf("Current Call Charge = %.1f", callCharge);
                    System.out.println("");
                    callIndex++;
                    break;
                case 2:
                    double smsCharge = gatherSMSInformation(smsPhoneDestinationArray, smsChargeArray, smsIndex);
                    smsIndex++;
    ...
    public static double gatherCallInformation(String[] callPhoneDestinationArray, int[] callMinutesArray, double[] callChargeArray, int index) {
        ...
        if (phoneDestination.charAt(2)== '9'){
            callCharge = callDuration * 0.1;
        } else {
            callCharge = callDuration * 0.2;
        }
    ...
    public static void displayBillInformation(int accNum, String name, String phone, int[] callMinutesArray, double[] callChargeArray,
        ...
        System.out.printf("\n\nThe monthly rent fees       : RM%5.2f%n",monthlyFees);
